/****************************************************************************
** Meta object code from reading C++ file 'nstatusbar.h'
**
...
#include <memory>
#include "../QStatusBar/nstatusbar.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'nstatusbar.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_NStatusBar_t {
    QByteArrayData data[47];
    char stringdata0[547];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NStatusBar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NStatusBar_t qt_meta_stringdata_NStatusBar = {
    {
QT_MOC_LITERAL(0, 0, 10), // "NStatusBar"
...
QT_MOC_LITERAL(46, 539, 7) // "yBorder"
    ...
    "NStatusBar\0yDisplay\0yAlignItems\0"
...
static const uint qt_meta_data_NStatusBar[] = {
...
void NStatusBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{

#ifndef QT_NO_PROPERTIES
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<NStatusBar *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject NStatusBar::staticMetaObject = { {
    &QStatusBar::staticMetaObject,
    qt_meta_stringdata_NStatusBar.data,
    qt_meta_data_NStatusBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *NStatusBar::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *NStatusBar::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_NStatusBar.stringdata0))
...
int NStatusBar::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
